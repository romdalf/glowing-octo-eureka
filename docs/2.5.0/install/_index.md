...
files. Checkout [device presentation](../concepts/volumes.md") for more details.
...
with any [supported Linux Distribution](../prerequisites/systemconfiguration#distribution-specifics).
