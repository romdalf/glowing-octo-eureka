...
../introduction/quickstart.md). If you are using the manifests
...
../prerequisites/systemconfiguration.md) and delete Ondat
...
`linux-image-extra-$(uname -r)` package of your distribution) on your nodes
following this [prerequisites page](
../prerequisites/systemconfiguration.md) and restart the container.
