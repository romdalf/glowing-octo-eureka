...
Ondat provisions a standard [Volume](../concepts/volumes.md) that provides 
...
[prerequisites page](../prerequisites/firewalls.md) to see the
...
- A Ondat RWX Volume is matched one-to-one with a PVC. Therefore the
  ...
  namespace.
- Ondat RWX Volumes support volume resize. Refer to the [resize](../operations/resize.md") 
